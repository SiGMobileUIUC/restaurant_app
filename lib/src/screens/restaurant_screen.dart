...
//Widget routed to scaffolding of restaurant page
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const MyHomePage(title: "UIUC Eats")),
                );
              },
...
class ShawarmaJointRoute extends StatelessWidget {
  const ShawarmaJointRoute({super.key});
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ShawarmaJointRoute()),
                      );
                    },
                  ),
                  Padding(
